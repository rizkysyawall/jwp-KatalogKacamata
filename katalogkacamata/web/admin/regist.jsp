<%-- 
    Document   : regist
    Created on : 16-Dec-2017, 15:24:31
    Author     : rizky
--%>
        ...
        <div id="section1" class="container row-center  mt-5">
            <div class="main-login main-center">
                <form class="form-horizontal" method="post" action="../upload">
                    <h4 class="text-center">REGIST ADMIN</h4>
                    <div class="form-group">
                        <label for="username" class="cols-sm-2 control-label"><b>Username</b></label>
                    ...
                    <div class="form-group">
                        <label for="jenkel" class="cols-sm-2 control-label"><b>Jenis Kelamin</b></label>
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <p>
                                    <input name="jenkel" type="radio" id="test1" value="Pria"/>
                                    <label for="test1">Laki-Laki</label>
                                    <input name="jenkel" type="radio" id="test2" value="Wanita"/>
                    ...
                    <div class="form-group ">
                        <input type="submit" class="btn btn-primary btn-lg btn-block login-button" value="Regist" name="regist">
                    </div>
                </form>
            </div>
        </div>
